...
import org.oracle.okafka.common.config.types.Password;
...
public class ConfigDef {
            ...
            switch (type) {
                ...
                case CLASS:
                    if (value instanceof Class)
                        ...
                        return Class.forName(trimmed, true, Utils.getContextOrAQClassLoader());
                    else
    ...
    public static class ValidString implements Validator {
        ...
        public void ensureValid(String name, Object o) {
            ...
            if (!validStrings.contains((String)o)) {
