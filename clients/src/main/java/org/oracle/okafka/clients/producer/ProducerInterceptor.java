 ...
 * they are published to the Transactional Event Queues.
 * <p>
...
public interface ProducerInterceptor<K, V> extends Configurable {
    /**
     * This is called from {@link org.oracle.okafka.clients.producer.KafkaProducer#send(ProducerRecord)} and
     * {@link org.oracle.okafka.clients.producer.KafkaProducer#send(ProducerRecord, Callback)} methods, before key and value
     ...
     * specified by {@link org.oracle.okafka.clients.producer.ProducerConfig#INTERCEPTOR_CLASSES_CONFIG}. The first interceptor
     ...
     *                 {@link org.oracle.okafka.clients.producer.KafkaProducer#send(ProducerRecord)}.
