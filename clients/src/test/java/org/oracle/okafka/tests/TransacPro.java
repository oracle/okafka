...
//			props.put("oracle.net.tns_admin","."); 
			...
			props.put("bootstrap.servers", "phoenix307317.dev3sub2phx.databasede3phx.oraclevcn.com:1521");
			
			//name of the service running on the database instance
			props.put("oracle.service.name", "cdb1_pdb1.regress.rdbms.dev.us.oracle.com");
			props.put("security.protocol","PLAINTEXT");
			...
			*/
			...
			try {
				...
				System.out.println("Disconnection exception");
				dcE.printStackTrace();
				producer.close();
			}catch (KafkaException e) {
				System.out.println("some kafka exception");
				producer.abortTransaction();
			}
		}		
		catch(Exception e)
