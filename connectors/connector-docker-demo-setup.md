 ...
 * Also in the [TxEventQConnectorExampleSetup/pl-sql/db-resources.sql](TxEventQConnectorExampleSetup/pl-sql/db-resources.sql) there are a few GRANT statements that need to be uncommented depending on your environment and whether you want to capture some diagnostics. 
