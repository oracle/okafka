...
/**
 * TxEventQSourceConnector is a connector interface that will pull data from an
 * ORACLE TxEventQ and send it to Kafka.
 */
public class TxEventQSourceConnector extends SourceConnector {
	...
	log.info("[{}] Starting Oracle TxEventQ Source Connector", Thread.currentThread().getId());
