...
public class TxEventQConnectorConfig extends AbstractConfig {
    ...
    public TxEventQConnectorConfig(ConfigDef definition, Map<String, String> originals, boolean doLog) {
    ...
    public static ConfigDef getConfig() {
        ...
        configDef.define(DATABASE_TNS_ALIAS_CONFIG, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, DATABASE_TNS_ALIAS_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.LONG, DATABASE_TNS_ALIAS_DISPLAY);

        configDef.define(DATABASE_WALLET_CONFIG, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, DATABASE_WALLET_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.MEDIUM, DATABASE_WALLET_DISPLAY);
        
        configDef.define(DATABASE_TNSNAMES_CONFIG, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, DATABASE_TNSNAMES_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.MEDIUM, DATABASE_TNSNAMES_DISPLAY);

        // TxEventQ Group Configurations
        groupName = "TxEventQ";
        orderInGroup = 0;

        configDef.define(TXEVENTQ_QUEUE_NAME, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, TXEVENTQ_QUEUE_NAME_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.MEDIUM, TXEVENTQ_QUEUE_NAME_DISPLAY);
        ...
        configDef.define(KAFKA_CONNECT_NAME, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, KAFKA_CONNECT_NAME_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.MEDIUM, KAFKA_CONNECT_NAME_DISPLAY);

        configDef.define(KAFKA_CONNECT_TASK_ID, ConfigDef.Type.STRING, "",
                ConfigDef.Importance.HIGH, KAFKA_CONNECT_TASK_ID_DOC,
                groupName, ++orderInGroup, ConfigDef.Width.MEDIUM, KAFKA_CONNECT_TASK_ID_DISPLAY);
